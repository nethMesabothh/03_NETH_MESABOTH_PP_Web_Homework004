...
export default function AddNewProjectComponent({ handleNewProject }) {
	...
	const handleSubmit = (e) => {
		...
		const newErrors = {
			projectName: !projectName.trim() ? "Project Name is required" : "",
			dueDate: !dueDate
				? "Due Date is required"
				: dueDate < today
				? "Due date cannot be in the past"
				: "",
			progress: !progress ? "Progress is required" : "",
		};
		...
		const newProjectData = { projectName, dueDate, progress, description };

		handleNewProject(newProjectData);
							...
							<div className="grid gap-4 mb-4 grid-cols-2">
								<div className="col-span-2">
									...
									<input
										...
										} text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500`}
									...
									<select
										...
										className={`bg-gray-50 border ${
											error.progress
												? "border-red-500 dark:border-red-500"
												: "border-gray-300 dark:border-gray-500"
										} text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500`}
										value={progress}
